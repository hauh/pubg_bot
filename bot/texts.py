	...
	'next': {
		'manage_matches': {
			...
			'next': {
				'set_room_': {
					'msg': (
						"Введите числовой PUBG ID комнаты и пароль для матча [{}] (через запятую)\n"
				...
				'set_winners_': {
					...
					'answers': {
						...
						'invalid_value': "Недопустимое значение (строка {})",
						'duplicate_player': "Игрок повторяется (строка {})",
						'duplicate_place': "Результат повторяется (строка {})",
						'wrong_kills': "Неверное количество убийств, должно быть {}",
						'not_enough': "В таблице не хватает победителей",
						'missing_something': "Чего-то ещё не хватает",
						'confirm': (
							"Победители введены успешно. Всего ставок: {}. "
