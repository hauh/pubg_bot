			...
			'next': {
				'debug_': {
					'answers': {
						...
						'debug_on': (
							"Режим дебага теперь ВКЛЮЧЕН! "
							"Бот не будет отвечать пользователям!"
						)
					}
				}
			},
...
match_failed = "Турнир [{}] отменён - не создана комната!"
match_started = "Турнир [{}] (PUBG ID {}) начался!"
match_ended = (
...
match_didnt_happen = "Турнир [{}] не состоялся. Ставка возвращена на ваш счёт."
match_is_nigh = (
