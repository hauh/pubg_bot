...
confirmation = {
	'msg': (
		"Вы записались на матч {game}, который стартует *через 15 минут*.\n"
		"*Ваш баланс*: {balance}.\n*Ставка*: {bet}\n."
		"Как только вы подтвердите списание, вы получите ID игры.\n"
	),
	'next': {
		'pay_for_the_game': {
			'btn': "Списать ставку"
...
too_expensive_match = "*На вашем счету недостаточно средств.*"
